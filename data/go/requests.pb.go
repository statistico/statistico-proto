...
type TeamResultRequest struct {
	...
	// Enrich the results response by including detailed match stats for each team
	IncludeTeamStats     bool     `protobuf:"varint,8,opt,name=include_team_stats,json=includeTeamStats,proto3" json:"include_team_stats,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *TeamResultRequest) GetIncludeTeamStats() bool {
	if m != nil {
		return m.IncludeTeamStats
	}
	return false
}
...
var fileDescriptor_9c9ccec99da7c9b4 = []byte{
	...
	,
}
