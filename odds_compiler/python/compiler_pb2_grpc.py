...
class OddsCompilerServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetEventMarket = channel.unary_unary(
                '/statistico_proto_odds_compiler.OddsCompilerService/GetEventMarket',
...
def add_OddsCompilerServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'statistico_proto_odds_compiler.OddsCompilerService', rpc_method_handlers)
...
class OddsCompilerService(object):
    ...
    def GetEventMarket(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/statistico_proto_odds_compiler.OddsCompilerService/GetEventMarket',
