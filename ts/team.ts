...
export namespace statistico {
    ...
    export class TeamServiceClient extends grpc_1.makeGenericClientConstructor(UnimplementedTeamServiceService.definition, "TeamService", {}) {
        ...
        GetTeamsBySeasonId: GrpcStreamServiceInterface<dependency_2.statistico.SeasonTeamsRequest, dependency_2.statistico.SeasonTeamsRequest> = (message: dependency_2.statistico.SeasonTeamsRequest, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): grpc_1.ClientReadableStream<dependency_2.statistico.SeasonTeamsRequest> => {
