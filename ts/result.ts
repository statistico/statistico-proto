...
export namespace statistico {
    ...
    export class ResultServiceClient extends grpc_1.makeGenericClientConstructor(UnimplementedResultServiceService.definition, "ResultService", {}) {
        ...
        GetHistoricalResultsForFixture: GrpcStreamServiceInterface<dependency_3.statistico.HistoricalResultRequest, dependency_3.statistico.HistoricalResultRequest> = (message: dependency_3.statistico.HistoricalResultRequest, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): grpc_1.ClientReadableStream<dependency_3.statistico.HistoricalResultRequest> => {
            return super.GetHistoricalResultsForFixture(message, metadata, options);
        };
        GetResultsForSeason: GrpcStreamServiceInterface<dependency_3.statistico.SeasonRequest, dependency_3.statistico.SeasonRequest> = (message: dependency_3.statistico.SeasonRequest, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): grpc_1.ClientReadableStream<dependency_3.statistico.SeasonRequest> => {
            return super.GetResultsForSeason(message, metadata, options);
        };
        GetResultsForTeam: GrpcStreamServiceInterface<dependency_3.statistico.TeamResultRequest, dependency_3.statistico.TeamResultRequest> = (message: dependency_3.statistico.TeamResultRequest, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): grpc_1.ClientReadableStream<dependency_3.statistico.TeamResultRequest> => {
