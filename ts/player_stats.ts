...
export namespace statistico {
    ...
    export class PlayerStatsServiceClient extends grpc_1.makeGenericClientConstructor(UnimplementedPlayerStatsServiceService.definition, "PlayerStatsService", {}) {
        ...
        GetTeamSeasonPlayerStats: GrpcStreamServiceInterface<TeamSeasonPlayStatsRequest, TeamSeasonPlayStatsRequest> = (message: TeamSeasonPlayStatsRequest, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): grpc_1.ClientReadableStream<TeamSeasonPlayStatsRequest> => {
