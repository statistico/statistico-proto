...
type TeamSeasonsRequest struct {
	...
	IncludeCup *wrapperspb.BoolValue `protobuf:"bytes,3,opt,name=include_cup,json=includeCup,proto3" json:"include_cup,omitempty"`
}
...
func (x *TeamSeasonsRequest) GetSort() *wrapperspb.StringValue {
	if x != nil {
		return x.Sort
	}
	return nil
...
func (x *TeamSeasonsRequest) GetIncludeCup() *wrapperspb.BoolValue {
	if x != nil {
		return x.IncludeCup
	}
	return nil
...
func (x *Season) GetIsCurrent() *wrapperspb.BoolValue {
	if x != nil {
		return x.IsCurrent
	}
	return nil
