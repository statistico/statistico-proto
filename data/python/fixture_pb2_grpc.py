...
class FixtureServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.FixtureByID = channel.unary_unary(
                '/statistico_proto_data.FixtureService/FixtureByID',
        ...
        self.Search = channel.unary_stream(
                '/statistico_proto_data.FixtureService/Search',
...
def add_FixtureServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'statistico_proto_data.FixtureService', rpc_method_handlers)
...
class FixtureService(object):
    ...
    def FixtureByID(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/statistico_proto_data.FixtureService/FixtureByID',
    ...
    def Search(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/statistico_proto_data.FixtureService/Search',
