...
class SeasonService(object):
    ...
    def GetSeasonsForCompetition(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/statistico.SeasonService/GetSeasonsForCompetition',
    ...
    def GetSeasonsForTeam(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/statistico.SeasonService/GetSeasonsForTeam',
