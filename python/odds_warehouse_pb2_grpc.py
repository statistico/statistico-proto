...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in odds_warehouse_pb2_grpc.py depends on'
...
def add_OddsWarehouseServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('statistico.OddsWarehouseService', rpc_method_handlers)
