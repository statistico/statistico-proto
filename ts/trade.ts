...
export namespace statistico {
    ...
    export class TradeServiceClient extends grpc_1.makeGenericClientConstructor(UnimplementedTradeServiceService.definition, "TradeService", {}) {
        ...
        SearchTrades: GrpcStreamServiceInterface<dependency_2.statistico.SearchTradesRequest, dependency_2.statistico.SearchTradesRequest> = (message: dependency_2.statistico.SearchTradesRequest, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): grpc_1.ClientReadableStream<dependency_2.statistico.SearchTradesRequest> => {
