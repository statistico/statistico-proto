...
func init() {
	proto.RegisterType((*Competition)(nil), "statistico_proto_data.Competition")
}
...
var fileDescriptor_25f6be7558319af9 = []byte{
	...
	,
}
...
func (c *competitionServiceClient) ListCompetitions(ctx context.Context, in *CompetitionRequest, opts ...grpc.CallOption) (CompetitionService_ListCompetitionsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_CompetitionService_serviceDesc.Streams[0], "/statistico_proto_data.CompetitionService/ListCompetitions", opts...)
	if err != nil {
		return nil, err
	}
...
var _CompetitionService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "statistico_proto_data.CompetitionService",
