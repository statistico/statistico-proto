...
class PlayerStatsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetPlayerStatsForFixture = channel.unary_unary(
                '/statistico_proto_data.PlayerStatsService/GetPlayerStatsForFixture',
        ...
        self.GetLineUpForFixture = channel.unary_unary(
                '/statistico_proto_data.PlayerStatsService/GetLineUpForFixture',
                request_serializer=requests__pb2.FixtureRequest.SerializeToString,
...
def add_PlayerStatsServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'statistico_proto_data.PlayerStatsService', rpc_method_handlers)
...
class PlayerStatsService(object):
    ...
    def GetPlayerStatsForFixture(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/statistico_proto_data.PlayerStatsService/GetPlayerStatsForFixture',
    ...
    def GetLineUpForFixture(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/statistico_proto_data.PlayerStatsService/GetLineUpForFixture',
            requests__pb2.FixtureRequest.SerializeToString,
