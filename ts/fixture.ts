...
export namespace statistico {
    ...
    export class FixtureServiceClient extends grpc_1.makeGenericClientConstructor(UnimplementedFixtureServiceService.definition, "FixtureService", {}) {
        ...
        ListSeasonFixtures: GrpcStreamServiceInterface<dependency_3.statistico.SeasonFixtureRequest, dependency_3.statistico.SeasonFixtureRequest> = (message: dependency_3.statistico.SeasonFixtureRequest, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): grpc_1.ClientReadableStream<dependency_3.statistico.SeasonFixtureRequest> => {
        ...
        Search: GrpcStreamServiceInterface<dependency_3.statistico.FixtureSearchRequest, dependency_3.statistico.FixtureSearchRequest> = (message: dependency_3.statistico.FixtureSearchRequest, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): grpc_1.ClientReadableStream<dependency_3.statistico.FixtureSearchRequest> => {
