...
export namespace statistico {
    ...
    export class CompetitionServiceClient extends grpc_1.makeGenericClientConstructor(UnimplementedCompetitionServiceService.definition, "CompetitionService", {}) {
        ...
        ListCompetitions: GrpcStreamServiceInterface<dependency_1.statistico.CompetitionRequest, dependency_1.statistico.CompetitionRequest> = (message: dependency_1.statistico.CompetitionRequest, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): grpc_1.ClientReadableStream<dependency_1.statistico.CompetitionRequest> => {
