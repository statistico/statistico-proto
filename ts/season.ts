...
export namespace statistico {
    ...
    export class SeasonServiceClient extends grpc_1.makeGenericClientConstructor(UnimplementedSeasonServiceService.definition, "SeasonService", {}) {
        ...
        GetSeasonsForCompetition: GrpcStreamServiceInterface<dependency_2.statistico.SeasonCompetitionRequest, Season> = (message: dependency_2.statistico.SeasonCompetitionRequest, metadata?: grpc_1.Metadata | grpc_1.CallOptions, options?: grpc_1.CallOptions): grpc_1.ClientReadableStream<Season> => {
