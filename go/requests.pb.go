...
type CreateStrategyRequest struct {
	...
	MinOdds        *wrappers.FloatValue `protobuf:"bytes,4,opt,name=min_odds,json=minOdds,proto3" json:"min_odds,omitempty"`
	MaxOdds        *wrappers.FloatValue `protobuf:"bytes,5,opt,name=max_odds,json=maxOdds,proto3" json:"max_odds,omitempty"`
...
type SearchTradesRequest struct {
	...
	Exchange      *wrappers.StringValue `protobuf:"bytes,5,opt,name=exchange,proto3" json:"exchange,omitempty"`
