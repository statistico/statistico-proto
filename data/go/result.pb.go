...
func init() {
	proto.RegisterType((*Result)(nil), "statisticodata.Result")
	proto.RegisterType((*MatchStats)(nil), "statisticodata.MatchStats")
}
...
var fileDescriptor_4feee897733d2100 = []byte{
	...
	,
}
...
func (c *resultServiceClient) GetById(ctx context.Context, in *ResultRequest, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
	err := c.cc.Invoke(ctx, "/statisticodata.ResultService/GetById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *resultServiceClient) GetHistoricalResultsForFixture(ctx context.Context, in *HistoricalResultRequest, opts ...grpc.CallOption) (ResultService_GetHistoricalResultsForFixtureClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ResultService_serviceDesc.Streams[0], "/statisticodata.ResultService/GetHistoricalResultsForFixture", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *resultServiceClient) GetResultsForSeason(ctx context.Context, in *SeasonRequest, opts ...grpc.CallOption) (ResultService_GetResultsForSeasonClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ResultService_serviceDesc.Streams[1], "/statisticodata.ResultService/GetResultsForSeason", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *resultServiceClient) GetResultsForTeam(ctx context.Context, in *TeamResultRequest, opts ...grpc.CallOption) (ResultService_GetResultsForTeamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ResultService_serviceDesc.Streams[2], "/statisticodata.ResultService/GetResultsForTeam", opts...)
	if err != nil {
		return nil, err
	}
...
func _ResultService_GetById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/statisticodata.ResultService/GetById",
	}
...
var _ResultService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "statisticodata.ResultService",
