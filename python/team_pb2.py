...
_COMPETITIONTEAMSREQUEST = DESCRIPTOR.message_types_by_name['CompetitionTeamsRequest']
_TEAMSRESPONSE = DESCRIPTOR.message_types_by_name['TeamsResponse']
Team = _reflection.GeneratedProtocolMessageType('Team', (_message.Message,), {
  'DESCRIPTOR' : _TEAM,
  '__module__' : 'team_pb2'
  # @@protoc_insertion_point(class_scope:statistico.Team)
  })
_sym_db.RegisterMessage(Team)

CompetitionTeamsRequest = _reflection.GeneratedProtocolMessageType('CompetitionTeamsRequest', (_message.Message,), {
  'DESCRIPTOR' : _COMPETITIONTEAMSREQUEST,
  '__module__' : 'team_pb2'
  # @@protoc_insertion_point(class_scope:statistico.CompetitionTeamsRequest)
  })
_sym_db.RegisterMessage(CompetitionTeamsRequest)

TeamsResponse = _reflection.GeneratedProtocolMessageType('TeamsResponse', (_message.Message,), {
  'DESCRIPTOR' : _TEAMSRESPONSE,
  '__module__' : 'team_pb2'
  # @@protoc_insertion_point(class_scope:statistico.TeamsResponse)
  })
_sym_db.RegisterMessage(TeamsResponse)

_TEAMSERVICE = DESCRIPTOR.services_by_name['TeamService']
