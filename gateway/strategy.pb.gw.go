...
/*
Package statistico is a reverse proxy.
...
func request_StrategyService_StrategyTradeSearch_0(ctx context.Context, marshaler runtime.Marshaler, client StrategyServiceClient, req *http.Request, pathParams map[string]string) (StrategyService_StrategyTradeSearchClient, runtime.ServerMetadata, error) {
	var protoReq StrategyTradeSearchRequest
	...
	stream, err := client.StrategyTradeSearch(ctx, &protoReq)
	if err != nil {
...
func RegisterStrategyServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server StrategyServiceServer) error {
	...
	mux.Handle("POST", pattern_StrategyService_StrategyTradeSearch_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterStrategyServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client StrategyServiceClient) error {
	...
	mux.Handle("POST", pattern_StrategyService_StrategyTradeSearch_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/statistico.StrategyService/StrategyTradeSearch")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_StrategyService_StrategyTradeSearch_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_StrategyService_StrategyTradeSearch_0(ctx, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	pattern_StrategyService_StrategyTradeSearch_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "strategy", "trade-search"}, ""))
)

var (
	forward_StrategyService_StrategyTradeSearch_0 = runtime.ForwardResponseStream
)
